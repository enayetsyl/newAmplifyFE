...
const ChatDashboard = ({ receiverId }) => {
  ...
  useEffect(() => {
    ...
    fetch("https://amplifymeetingbe.onrender.com/api/users")
  ...
  useEffect(() => {
    const newSocket = io("https://amplifymeetingbe.onrender.com/user-namespace", {
      auth: {
        token: user._id,
      },
    });
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://amplifymeetingbe.onrender.com/save-chat", {
      method: "POST",
      headers: {
