...
const ChatDashboard = ({ receiverId }) => {
  ...
  useEffect(() => {
    ...
    fetch("https://amplifybe-1.onrender.com/api/users")
  ...
  useEffect(() => {
    const newSocket = io("https://amplifybe-1.onrender.com/user-namespace", {
      auth: {
        token: user._id,
      },
    });
  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://amplifybe-1.onrender.com/save-chat", {
      method: "POST",
      headers: {
