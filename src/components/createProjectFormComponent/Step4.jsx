...
const Step4 = ({ formData, setFormData }) => {
  ...
  useEffect(() => {
    const fetchBreakoutRooms = async () => {
      try {
        const response = await axios.get(`https://amplifybe-2.onrender.com/get-all-breakout-rooms`, {
  ...
  const removeBreakoutRoom = async (index) => {
    ...
    try {
      await axios.delete(`https://amplifybe-2.onrender.com/delete-breakout-room/${roomToDelete._id}`);
