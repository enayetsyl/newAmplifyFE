...
const Page = () => {
 ...
 try {
  const response = await axios.post(`https://amplifymeetingbe.onrender.com/api/live-meeting/join-meeting-participant`, {name: formData.fullName, role:"Participant", meetingId: meetingId});
