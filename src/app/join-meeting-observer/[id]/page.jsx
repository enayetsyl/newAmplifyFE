...
const page = () => {
 ...
 try {
  ...
  const response = await axios.post(`https://amplifymeetingbe.onrender.com/api/live-meeting/join-meeting-observer`, {name: formData.fullName, role:"observer", passcode: formData.passcode, meetingId: meetingId});
