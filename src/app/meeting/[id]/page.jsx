...
const page = () => {
    ...
    const getRemovedParticipantsList = async () => {
      try {
        const response = await axios.get(
          `https://amplifymeetingbe.onrender.com/api/live-meeting/get-removed-participants-list/${params.id}`
        );
  ...
  const getWaitingList = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/waiting-list/${meetingId}`
      );
  ...
  const getObserverList = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/observer-list/${meetingId}`
      );
  ...
  const acceptParticipant = async (participant) => {
    try {
      const response = await axios.put(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/accept-from-waiting-list`,
        {
  ...
  const getMeetingStatus = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/get-meeting-status/${meetingId}`
      );
  ...
  const getWebRtcMeetingId = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/get-webrtc-meeting-id/${meetingId}`
      );
  ...
  const getIframeLinkMeetingId = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/get-iframe-link/${meetingId}`
      );
      // https://serverzoom-mpbv.onrender.com/room/
      // https://testing--inspiring-cendol-60afd6.netlify.app
      // const iframeLink = `https://testing--inspiring-cendol-60afd6.netlify.app/room/${response?.data?.webRtcRoomId}`;
  ...
  const sendMessageParticipant = async (message) => {
    try {
      const response = await axios.post(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/send-message-to-participant`,
        {
          message: message,
          meetingId: params.id,
        }
  ...
  const sendMessageObserver = async (message) => {
    try {
      const response = await axios.post(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/send-message-to-observer`,
        {
          message: message,
          meetingId: params.id,
        }
  ...
  const getParticipantChat = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/get-participant-chat/${meetingId}`
      );
  ...
  const getObserverChat = async (meetingId) => {
    try {
      const response = await axios.get(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/get-observer-chat/${meetingId}`
      );
  ...
  const removeParticipant = async (name, role, meetingId) => {
    try {
      response = await axios.put(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/remove-participant-from-meeting`,
        {
          name: name,
          role: role,
          meetingId: meetingId,
  ...
  const setStartStreaming = async (meetingId) => {
    try {
      const response = await axios.put(
        `https://amplifymeetingbe.onrender.com/api/live-meeting/start-streaming`,
        {
          meetingId: meetingId,
        }
      );
